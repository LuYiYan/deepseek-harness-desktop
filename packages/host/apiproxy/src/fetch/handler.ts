...
import {
  ...
  hostListDirectoryRequestSchema, hostListPathRequestSchema, hostOpenPathRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.listPath': { schema: hostListPathRequestSchema, invoke: (api, r, signal) => api.host.listPath(r, signal) },
