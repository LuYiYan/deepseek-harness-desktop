...
import {
  ...
  hostListDirectoryValueSchema, hostListPathValueSchema, hostOpenPathValueSchema, hostPickDirectoryValueSchema,
...
export interface IApiClient {
  ...
  host: {
    ...
    listPath(payload: RequestPayload<'host.listPath'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.listPath'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'host.listPath': hostListPathValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    listPath: (payload, signal) => this.callUnary('host.listPath', payload, signal),
