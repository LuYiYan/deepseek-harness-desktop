...
/**
 * No runtime invariant: the explorer registers one overlay entry and reads
 * listings through the workspaces service; the registration is an effect
 * owned and observed by the slot registry, not a durable relation this
